output "function_app_id" {
  ...
  value       = azurerm_windows_function_app.health_assistant.id
}

output "function_app_name" {
  description = "The name of the Function App."
  value       = azurerm_windows_function_app.health_assistant.name
}

output "function_app_default_hostname" {
  description = "The default hostname of the Function App."
  value       = azurerm_windows_function_app.health_assistant.default_hostname
}
...
output "function_app_identity_principal_id" {
  ...
  value       = azurerm_windows_function_app.health_assistant.identity[0].principal_id
}
